...
<div class="container d-flex justify-content-center">
      ...
      <b><p class="modaldescription">Merch ID:</b> <?php echo $row1["merch_id"] ?> <br>

    <label><b>Merch Name:</b> <input type="text" id="merch_name" name="merch_name" maxlength="10" value="<?php echo htmlspecialchars($row1["merch_name"]) ?>" required></label><br>
<label><b>Price: PHP</b><input type="text" id="price" name="price" maxlength="10" value="<?php echo htmlspecialchars($row1["price"]) ?>"></label><br>
<label><b>Stocks:</b> <input type="text" id="stock_available" name="stock_available" maxlength="10" value="<?php echo htmlspecialchars($row1["stock_available"]) ?>"></label><br>
